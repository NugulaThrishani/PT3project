...
def add_task(request):
    if request.method=='POST':
        ...
        return render(request, 'facultyapp/add_task.html', {'form': form, 'tasks': tasks})
...
def view_student_list(request):
    ...
    return render(request, 'facultyapp/view_student list.html', context)
...
def post_marks(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            from_email = 'thrishanichowdary@gmail.com'
